...
setting('backend', 'serial', ['Serial', 'LPR'], 'preference', 'hidden').setLabel('Backend', 'Backend to use to print gcode')
...
setting('lpr_host', '', str, 'preference', 'hidden').setLabel('Hostname', 'Hostname of LPR print server')
setting('lpr_queue', 'lp', str, 'preference', 'hidden').setLabel('Queue', 'Queue on LPR print server')
